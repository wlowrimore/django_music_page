...
def _accept(prefix):
    ...
    if is_riff_file_format and is_webp_file and is_valid_vp8_mode:
        if not SUPPORTED:
            return (
                "img file could not be identified because WEBP support not installed"
            )
        return True
    ...
    def load(self):
        if _webp.HAVE_WEBPANIM:
            if self.__loaded != self.__logical_frame:
                ...
                # We need to load the img data for this frame
    ...
    try:
        for ims in [im] + append_images:
            ...
            for idx in range(nfr):
                ...
                # Make sure img mode is supported
                frame = ims
                rawmode = ims.mode
...
if SUPPORTED:
    ...
    Image.register_mime(WebPImageFile.format, "img/webp")
