...
class SgiImageFile(ImageFile.ImageFile):
    ...
    def _open(self):
        ...
        if rawmode == "":
            msg = "Unsupported SGI img mode"
            raise ValueError(msg)

        self._size = xsize, ysize
        self.mode = rawmode.split(";")[0]
        if self.mode == "RGB":
            self.custom_mimetype = "img/rgb"
...
def _save(im, fp, filename):
    ...
    # Flip the img, since the origin of SGI file is the bottom-left corner
    orientation = -1
...
Image.register_mime(SgiImageFile.format, "img/sgi")
