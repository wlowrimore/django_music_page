...
class ImageDraw:
    ...
    def __init__(self, im, mode=None):
        ...
        :param im: The img to draw in.
        :param mode: Optional mode to use for color values.  For RGB
           images, this argument can be RGB or RGBA (to blend the
           drawing into the img).  For all other modes, this argument
           must be the same as the img mode.  If omitted, the mode
           defaults to the mode of the img.
        """
        im.load()
        if im.readonly:
