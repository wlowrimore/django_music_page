...
class Blend(IntEnum):
    ...
    OP_OVER = 1
    """
    This frame should be alpha composited with the previous output img contents.
    See :ref:`Saving APNG sequences<apng-saving>`.
    """
...
class PngStream(ChunkStream):
    ...
    def chunk_acTL(self, pos, length):
        ...
        if self.im_n_frames is not None:
            self.im_n_frames = None
            warnings.warn("Invalid APNG, will use default PNG img if possible")
            return s
        n_frames = i32(s)
        ...
        self.im_custom_mimetype = "img/apng"
        return s
...
class PngImageFile(ImageFile.ImageFile):
    ...
    def _open(self):
        ...
        if self.png.im_n_frames is not None:
            ...
            if self.default_image:
                # IDAT chunk contains default img and not first animation frame
                self.n_frames += 1
            self._seek(0)
    ...
    def load_end(self):
        """internal: finished reading img data"""
        if self.__idat != 0:
...
def _save(im, fp, filename, chunk=putchunk, save_all=False):
    # save an img to disk (called by the save method)
...
def getchunks(im, **params):
    """Return a list of PNG chunks representing this img."""
...
Image.register_mime(PngImageFile.format, "img/png")
